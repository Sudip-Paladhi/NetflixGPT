...
const [errorMessage, setErrorMessage] = useState(null)
  ...
  return (
    <>
      ...
      <form onSubmit={(e) => e.preventDefault()} className="absolute w-4/12 mx-auto right-0 left-0 p-12 my-24 text-white bg-black bg-opacity-80">
        ...
        <button className="bg-red-700 p-4 my-6 w-full rounded" onClick={handleButtonClick}>
          {isSignInForm ? "Sign In" : "Sign Up"}
        </button>
